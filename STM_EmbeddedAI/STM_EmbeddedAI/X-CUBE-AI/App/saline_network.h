/**
  ******************************************************************************
  * @file    saline_network.h
  * @author  AST Embedded Analytics Research Platform
  * @date    Wed Oct  5 14:42:31 2022
...
#ifndef AI_SALINE_NETWORK_H
#define AI_SALINE_NETWORK_H
#pragma once

#include "saline_network_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SALINE_NETWORK_MODEL_NAME          "saline_network"
#define AI_SALINE_NETWORK_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_SALINE_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SALINE_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SALINE_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SALINE_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_SALINE_NETWORK_IN \
  ai_saline_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SALINE_NETWORK_IN_SIZE { \
  AI_SALINE_NETWORK_IN_1_SIZE, \
}
#define AI_SALINE_NETWORK_IN_SIZE_BYTES { \
  AI_SALINE_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_SALINE_NETWORK_IN_1_HEIGHT      (64)
#define AI_SALINE_NETWORK_IN_1_WIDTH       (64)
#define AI_SALINE_NETWORK_IN_1_CHANNEL     (3)
#define AI_SALINE_NETWORK_IN_1_SIZE        (64 * 64 * 3)
#define AI_SALINE_NETWORK_IN_1_SIZE_BYTES  (49152)

/******************************************************************************/
#define AI_SALINE_NETWORK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SALINE_NETWORK_OUT \
  ai_saline_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SALINE_NETWORK_OUT_SIZE { \
  AI_SALINE_NETWORK_OUT_1_SIZE, \
}
#define AI_SALINE_NETWORK_OUT_SIZE_BYTES { \
  AI_SALINE_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_SALINE_NETWORK_OUT_1_CHANNEL     (4)
#define AI_SALINE_NETWORK_OUT_1_SIZE        (4)
#define AI_SALINE_NETWORK_OUT_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_SALINE_NETWORK_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup saline_network
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_saline_network_get_info(
 ...
 */
AI_API_ENTRY
ai_bool ai_saline_network_get_report(
  ai_handle network, ai_network_report* report);
 ...
 */
AI_API_ENTRY
ai_handle ai_saline_network_destroy(ai_handle network);

/*!
 * @brief Initialize the data structures of the network.
 * @ingroup saline_network
 * @details This API initialized the network after a successfull
 * @ref ai_saline_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_saline_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_saline_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_saline_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SALINE_NETWORK_*
 * defines into file @ref saline_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_saline_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SALINE_NETWORK_H */
