...
#include "saline_network.h"
#include "saline_network_data.h"
...
#define AI_NET_OBJ_INSTANCE g_saline_network
 
#undef AI_SALINE_NETWORK_MODEL_SIGNATURE
#define AI_SALINE_NETWORK_MODEL_SIGNATURE     "6b66b6efda42b6fa87d42b8f12dce746"
...
#define AI_TOOLS_DATE_TIME   "Wed Oct  5 14:42:31 2022"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_SALINE_NETWORK_N_BATCHES
#define AI_SALINE_NETWORK_N_BATCHES         (1)

static ai_ptr g_saline_network_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_saline_network_weights_map[1] = AI_C_ARRAY_INIT;
...
/* Array#22 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_5_conv2d_scratch0_array, AI_ARRAY_FORMAT_FLOAT,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  18, 0x0,
  AI_SHAPE_INIT(4, 3136, 128, 1, 1), AI_STRIDE_INIT(4, 4, 12544, 1605632, 1605632),
...
/* Tensor #23 */
AI_TENSOR_OBJ_DECLARE(
  conv2d_5_conv2d_scratch0, AI_STATIC,
  23, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 30, 2), AI_STRIDE_INIT(4, 4, 4, 128, 3840),
  1, &conv2d_5_conv2d_scratch0_array, NULL)

/* Tensor #24 */
AI_TENSOR_OBJ_DECLARE(
  conv2d_7_conv2d_scratch0, AI_STATIC,
  24, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 15, 2), AI_STRIDE_INIT(4, 4, 4, 256, 3840),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_7_conv2d_scratch0)
)

AI_LAYER_OBJ_DECLARE(
  conv2d_7_conv2d_layer, 7,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_5_conv2d_scratch0)
)

AI_LAYER_OBJ_DECLARE(
  conv2d_5_conv2d_layer, 4,
  OPTIMIZED_CONV2D_TYPE, 0x0, NULL,
  conv2d_nl_pool, forward_conv2d_nl_pool,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1870480, 1, 1),
    1870480, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 161280, 1, 1),
    161280, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SALINE_NETWORK_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SALINE_NETWORK_OUT_NUM, &dense_3_output),
  &conv2d_4_conv2d_layer, 0, NULL)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_SALINE_NETWORK_MODEL_NAME,
      .model_signature   = AI_SALINE_NETWORK_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_i32 ai_saline_network_forward(ai_handle network, const ai_buffer* input)
{
